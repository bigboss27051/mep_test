...
class MyfindModel extends BaseModel
{
    var $_num_iid  = "";
	var $_title  = "";	
	var $_desc_short = "";
	...
	var $_apiKey = 'AIzaSyDsrMJVv19IJmzVax8PNGxX2K7H0OyxjcM';	 
		...
		function _translate($text)
		{
			...
			$url = 'https://www.googleapis.com/language/translate/v2?key=' . $this->_apiKey . '&q=' . rawurlencode($text) . '&source=zh_cn&target=th';
     	...
     	function _idform($url)
		{
			...
			if($set_id =="")
			{
				$set_id=  str_replace("/item/","",$parts['path']);
				$set_id=  str_replace(".html","",$set_id);
				$set_id=  str_replace(".htm","",$set_id);
