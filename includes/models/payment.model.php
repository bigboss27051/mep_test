...
class PaymentModel extends BaseModel
{
	...
	function get_list_paymentadmin()
    {
	...
	function get_list_paymentadmin2()
    {
	...
	function get_list_opadmin_all()
    {
		$sort  = 'payment_id';
        $order = 'asc';
		$res ="";
        $regions =  $this->find(array(
                'conditions' => "store_id  = 0 and enabled =1",
                 'order' => "$sort $order",
            ));
		
		foreach ($regions as $region)
        {
            $res  .= "<option value='". $region['payment_id'] ."'>".$region['payment_name']."</option>"	 ;
        }
        return $res;
	}
	function get_list_opadmin_mem()
    {
		$sort  = 'payment_id';
        $order = 'asc';
		$res ="";
	...
	function get_list_opadmin_mem2()
    {
		$sort  = 'payment_id';
        $order = 'asc';
		$res ="";
        $regions =  $this->find(array(
                'conditions' => "  enabled =1 and config=1",
                 'order' => "$sort $order",
            ));
 	...
 	function get_list_opadmin()
    {
		$res ="";
        $regions =  $this->find(array(
                'conditions' => "store_id = 0 and payment_id = 1",
	...
	function get_list_opadmin_only()
    {
		$res ="";
        $regions =  $this->find(array(
                'conditions' => "store_id = 0 and payment_id = 3",
