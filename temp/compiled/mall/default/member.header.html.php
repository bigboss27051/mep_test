...
<div id="header">
    ...
    <div id="subnav">
        ...
        <a class="help" href="<?php echo url('app=article&code=' . $this->_var['acc_help']. ''); ?>">help_center</a>
        </p>
    </div>
    ...
    <div id="topbtn">
        ...
        <span id="child_nav">
            <a class="link user" href="<?php echo url('app=member'); ?>">member_center</a>
            <ul id="float_layer">
                <div id="adorn1"></div>
                <div id="adorn2"></div>
        ...
        <span>|</span>
        <a class="link" href="<?php echo url('app=category'); ?>">i_want_buy</a>
        <span>|</span>
        <a class="link" href="<?php echo url('app=my_goods&act=add'); ?>">i_want_sell</a>
    </div>
