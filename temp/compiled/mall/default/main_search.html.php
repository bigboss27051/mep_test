<div class="intro" style="background-image: url(<?php echo $this->lib_base . "/" . 'templates2/images/bg3.png'; ?>);">
        <div class="dtable hw100">
            <div class="dtable-cell hw100">
                <div class="container text-center">
                    <h1 class="intro-title animated fadeInDown"> </h1>

                    <p class="sub animateme fittext3 animated fadeIn">  </p>
