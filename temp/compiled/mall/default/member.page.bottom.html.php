...
<div class="page">
    <a class="stat"><?php echo sprintf('total_item', $this->_var['page_info']['item_count']); ?></a>
...
?>
    ...
    <a class="down" href="<?php echo $this->_var['page_info']['next_link']; ?>">ต่อไป</a>
    <?php else: ?>
    <span class="down_no">ต่อไป</span>
    <?php endif; ?>
</div>
<?php endif; ?>