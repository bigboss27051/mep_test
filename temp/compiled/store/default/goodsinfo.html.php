...
<div class="ware_info">
    <div class="ware_pic">
        ...
        <div class="bottom_btn">
            <!--<a class="collect" href="javascript:collect_goods(<?php echo $this->_var['goods']['goods_id']; ?>);" title="เก็บรวบรวมสินค้า"></a>-->
...
?>
        ...
        <ul id="btn_list">
            <li id="btn_list1" title="collect_goods">
                <ul class="drop_down">
...
?>
            ...
            <li id="btn_list2" title="share_goods">
                <ul class="drop_down">
                    <?php $_from = $this->_var['share']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item');if (count($_from)):
    foreach ($_from AS $this->_var['item']):
?>
    ...
    <div class="ware_text">
        <div class="rate">
            <span class="letter1">ราคา: </span><span class="fontColor3" ectype="goods_price"><?php echo price_format($this->_var['goods']['_specs']['0']['price']); ?></span><br />
            <span class="letter1">brand: </span><?php echo htmlspecialchars($this->_var['goods']['brand']); ?><br />
...
?><?php echo $this->_var['tag']; ?>&nbsp;&nbsp;&nbsp;<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?><br />
            ขาย: <?php echo $this->_var['sales_info']; ?><?php echo $this->_var['comments']; ?><br />
            region: <?php echo htmlspecialchars($this->_var['store']['region_name']); ?>
        </div>
        ...
        <div class="handle">
            ...
            <?php endif; ?>
            <ul>
                <li class="handle_title">จำนวนการซื้อ: </li>
                <li>
                    <input type="text" class="text width1" name="" id="quantity" value="1" />
                    ชิ้น（stock<span class="stock" ectype="goods_stock"><?php echo $this->_var['goods']['_specs']['0']['stock']; ?></span>ชิ้น）
                </li>
            </ul>
            <?php if ($this->_var['goods']['spec_qty'] > 0): ?>
            <ul>
                <li class="handle_title">ที่คุณจะเลือก: </li>
        ...
        <ul class="ware_btn">
            <div class="ware_cen" style="display:none">
                <div class="ware_center">
                    <h1>
                        <span class="dialog_title">สินค้าได้รับการเพิ่มในรถเข็น</span>
                        <span class="close_link" title="ปิด" onmouseover="this.className = 'close_hover'" onmouseout="this.className = 'close_link'" onclick="slideUp_fn();"></span>
                    </h1>
                    <div class="ware_cen_btn">
                        <p class="ware_text_p">รวมสินค้าที่รถเข็น <span class="bold_num">3</span> รวมสินค้า <span class="bold_mly">658.00</span></p>
                        <p class="ware_text_btn">
                            <input type="submit" class="btn1" name="" value="ดูรถเข็น" onclick="location.href='<?php echo $this->_var['site_url']; ?>/index.php?app=cart'" />
                            <input type="submit" class="btn2" name="" value="ดำเนินการต่อการเลือกซื้อสินค้า" onclick="$('.ware_cen').css({'display':'none'});" />
                        </p>
                    </div>
                </div>
            ...
            <!--<li class="btn_c1" title="ซื้อทันที"><a href="#"></a></li>-->
            <li class="btn_c2" title="ใส่ในรถเข็น"><a href="javascript:buy();"></a></li>
            <li class="btn_c3" title="เก็บรวบรวมสินค้า"><a href="javascript:collect_goods(<?php echo $this->_var['goods']['goods_id']; ?>);"></a></li>
        </ul>
    </div>
