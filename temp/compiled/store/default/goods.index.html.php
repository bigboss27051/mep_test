...
<div id="content">
    ...
    <div id="right">
        ...
        <ul class="user_menu">
            ...
            <li><a class="active" href="<?php echo url('app=goods&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>รายละเอียดสินค้า</span></a></li>
            <li><a class="normal" href="<?php echo url('app=goods&act=comments&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>ความคิดเห็น</span></a></li>
            <li><a class="normal" href="<?php echo url('app=goods&act=saleslog&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>บันทึกการขาย</span></a></li>
            <li><a class="normal" href="<?php echo url('app=goods&act=qa&id=' . $this->_var['goods']['goods_id']. ''); ?>#module"><span>ผลิตภัณฑ์ที่ปรึกษา</span></a></li>
        </ul>
